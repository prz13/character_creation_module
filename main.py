...
"""Импорт модуля и отдельных функций"""
...
def attack(char_name: str, char_class: str) -> str:
    """Описывает работу функции и выбор персонажа attack"""
...
def defence(char_name: str, char_class: str) -> str:
    """Описывает работу функции защиты и боевые навыки defence"""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Описывает работу функции специальных навыков special"""
    if char_class == 'warrior':
        return (
...
def start_training(char_name: str, char_class: str) -> str:
    """Описывает работу функции обучение start_training"""
    if char_class == 'warrior':
